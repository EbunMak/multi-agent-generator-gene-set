import os
import json
from rag_pipeline_gene_checker_llama import create_control_flow
from utils import GraphState

PROCESSED_GENES_FILE = "processed_genes_llama.json"
PROCESSED_SETS_FILE = "processed_gene_sets_llama.txt"
...
def main():
    ...
    processed_phenotypes_file = "out/processed_phenotypes_llama3.txt"
