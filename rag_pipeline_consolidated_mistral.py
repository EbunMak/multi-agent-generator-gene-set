...
def generate(state, llm_name):
    ...
    phenotype = state["phenotype"]
    safe_name = safe_name = phenotype["name"]
...
def create_control_flow():
    ...
    workflow.add_node("grade_ms",     lambda s: grade_abstracts(s, "mistral:7b"))
