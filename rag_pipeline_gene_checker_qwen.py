...
def create_control_flow():
    ...
    # Step 2: Grade abstracts for phenotype + gene relevance using Qwen
    workflow.add_node("grade_ds", lambda s: grade_abstracts(s, "qwen3:32b"))

    # Step 3: Generate inference (validate gene–phenotype association)
    workflow.add_node("gen_ds", lambda s: generate(s, "qwen3:32b"))
